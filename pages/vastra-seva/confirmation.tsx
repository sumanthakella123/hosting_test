// pages/vastra-seva/confirmation.tsx
import { useRouter } from 'next/router';
import { useEffect, useState } from 'react';

export default function VastraSevaConfirmation() {
  ...
  useEffect(() => {
    ...
    const updateOrderStatus = async () => {
      try {
        const response = await fetch('/api/vastra-seva/confirm-order', {
          method: 'POST',
          headers: {
    ...
    <div className="p-4 max-w-lg mx-auto">
      <div className="border border-green-300 p-6 rounded-lg text-center shadow-md">
        {error ? (
          ...
          <>
            <h1 className="text-2xl font-semibold mb-4 text-green-600">Vastra Seva Booking Confirmed!</h1>
        ...
        <button
          onClick={() => router.push('/vastra-seva')}
